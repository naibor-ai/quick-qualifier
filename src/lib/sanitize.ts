...
export function sanitizeGhlConfig(rawValues: Record<string, unknown>) {
  ...
  return {
    ...
    fees: {
      ...
      admin: get('calc_fee_admin', 995),
      processing: get('calc_fee_processing', 595),
      underwriting: get('calc_fee_underwriting', 995),
      appraisal: get('calc_fee_appraisal', 550),
      creditReport: get('calc_fee_credit_report', 65),
      floodCert: get('calc_fee_flood_cert', 15),
      taxService: get('calc_fee_tax_service', 85),
      docPrep: get('calc_fee_doc_prep', 150),
      settlement: get('calc_fee_settlement', 750),
      notary: get('calc_fee_notary', 150),
      recording: get('calc_fee_recording', 150),
