...
export function sanitizeGhlConfig(rawValues: Record<string, unknown>) {
  ...
  return {
    ...
    fees: {
      ...
      courier: get('calc_fee_courier', 0),
    ...
    feesRefi: {
      originationPoints: get('calc_fee_origination_pts', 0),
      admin: get('calc_fee_admin', 0),
      processing: get('calc_fee_processing_refi', 895),
      underwriting: get('calc_fee_underwriting_refi', 995),
      appraisal: get('calc_fee_appraisal', 650),
      creditReport: get('calc_fee_credit_report', 150),
      floodCert: get('calc_fee_flood_cert', 30),
      taxService: get('calc_fee_tax_service_refi', 59),
      docPrep: get('calc_fee_doc_prep_refi', 595),
      settlement: get('calc_fee_settlement_refi', 400),
      notary: get('calc_fee_notary', 350),
      recording: get('calc_fee_recording', 275),
      courier: get('calc_fee_courier', 35),
      ownerTitlePolicy: get('calc_fee_owner_title_policy_refi', 0), // Usually 0 for refi? (Not in image)
      lenderTitlePolicy: get('calc_fee_lender_title_policy_refi', 515),
      pestInspection: get('calc_fee_pest_inspection', 0),
      propertyInspection: get('calc_fee_property_inspection', 0),
      poolInspection: get('calc_fee_pool_inspection', 0),
    },

    prepaids: {
      taxMonths: get('calc_reserves_tax_mo', 6),
      insuranceMonths: get('calc_reserves_ins_mo', 15),
