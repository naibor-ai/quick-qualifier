      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            />
            <h1 className="text-2xl font-bold bg-linear-to-b from-[#2A8BB3] to-[#31B2E8] bg-clip-text text-transparent">
              {t('common.appName')}
            </h1>
          </div>
          <LanguageSwitcher />
          ...
          <div className="grid gap-4 grid-cols-2 max-w-2xl mx-auto">
            {loanCalculators.map((calc) => (
              <Link
                key={calc.href}
                href={calc.href}
                className="group rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-all hover:shadow-lg hover:border-[#31B2E8] hover:-translate-y-1 text-center"
              >
                <span className="text-lg font-medium text-slate-800 group-hover:bg-linear-to-b group-hover:from-[#2A8BB3] group-hover:to-[#31B2E8] group-hover:bg-clip-text group-hover:text-transparent transition-colors">
                  {calc.label}
                </span>
              </Link>
            ))}
        ...
        <div className="mx-auto max-w-7xl px-4 py-8 text-center">
          ...
          <div className="flex items-center justify-center gap-6 text-sm text-slate-500">
            {config?.company?.loPhone && (
              <a href={`tel:${config.company.loPhone}`} className="flex items-center gap-2 hover:bg-linear-to-b hover:from-[#2A8BB3] hover:to-[#31B2E8] hover:bg-clip-text hover:text-transparent transition-colors">
            ...
            {config?.company?.loEmail && (
              <a href={`mailto:${config.company.loEmail}`} className="flex items-center gap-2 hover:bg-linear-to-b hover:from-[#2A8BB3] hover:to-[#31B2E8] hover:bg-clip-text hover:text-transparent transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
