      ...
      <div className="relative">
        <select
          ...
          className={`
            ...
            border-slate-300 focus:border-[#31B2E8] focus:ring-[#E6F4F9]
        ...
        {agentsLoading && (
          <div className="absolute right-3 top-1/2 -translate-y-1/2">
            <div className="h-4 w-4 animate-spin rounded-full border-2 border-slate-300 border-t-[#31B2E8]" />
          </div>
        )}
      </div>

      {selectedAgent && (
        <div className="mt-2 p-3 bg-[#E6F4F9] rounded-lg border border-[#31B2E8]/30">
